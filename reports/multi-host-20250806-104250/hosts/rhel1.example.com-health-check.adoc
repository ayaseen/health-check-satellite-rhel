...
* ✓ Firewall default zone is custom: ERROR:dbus.proxies:Introspect error on :1.3:/org/fedoraproject/FirewallD1: dbus.exceptions.DBusException: org.fedoraproject.FirewallD1.NotAuthorizedException: Not Authorized(uid): org.fedoraproject.FirewallD1.info
...
Not root, Subscription Management repositories not updated
YUM version: 4.14.0
cachedir: /var/tmp/dnf-ayaseen-fpn83rj6
...
----
Not root, Subscription Management repositories not updated
Waiting for process with pid 7415 to finish.
Waiting for process with pid 7756 to finish.
