...
| Found 1 CPU configuration or utilization issues 
...
System has very low CPU count (less than 2 cores)

Consider allocating more CPU cores if this is a virtual machine

*Reference Link(s)*

* https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/8/html/monitoring_and_managing_system_status_and_performance/monitoring-cpu-usage-using-performance-co-pilot_monitoring-and-managing-system-status-and-performance
...
----
total 4
-rw-r--r--. 1 root root 358 Aug  6 09:38 redhat.repo
...
Waiting for process with pid 4955 to finish.
Waiting for process with pid 5005 to finish.
...
Not root, Subscription Management repositories not updated
Waiting for process with pid 4955 to finish.
Waiting for process with pid 4996 to finish.
Waiting for process with pid 5010 to finish.
Waiting for process with pid 5014 to finish.
...
-------------------------------------------------------------------------------
     1 |                          | 2025-08-06 09:09 | Install        |  393 EE
